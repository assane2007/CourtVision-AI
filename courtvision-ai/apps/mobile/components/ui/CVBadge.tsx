...
const VARIANT_COLORS: Record<CVBadgeVariant, { bg: string; text: string; border: string }> = {
  brand: { bg: T.color.brand.muted, text: T.color.brand.primary, border: T.color.border.accent },
  ...
  info: { bg: T.color.ai.muted, text: T.color.ai.primary, border: T.color.border.ai },
      ...
      style={[
        {
          ...
          gap: cfg.gap,
          ...(glow && variant === 'brand' ? T.glow.cta(colors.text) : {}),
        },
        style,
      ]}
