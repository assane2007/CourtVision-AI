...
export type TranslationKey =
  ...
  | 'landing.testimonial7.name'
  | 'landing.testimonial7.role'
  | 'landing.testimonial7.quote'
  | 'landing.testimonial8.name'
  | 'landing.testimonial8.role'
  | 'landing.testimonial8.quote'
  ...
  | 'landing.statsBar.reviewsCount'
  | 'pricing.review1'
  | 'pricing.review1.author'
  | 'pricing.review2'
  | 'pricing.review2.author'
  | 'pricing.review3'
  | 'pricing.review3.author'
  | 'pricing.reviewsTitle'
  | 'landing.featuredIn'
  | 'landing.awards'
  | 'landing.award1'
  | 'landing.award2'
