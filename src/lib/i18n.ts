...
export type TranslationKey =
  // Navigation & Screens
  | 'nav.home' |'nav.plans' |'nav.training' |'nav.stats' |'nav.profile' |'screen.achievements' |'screen.leaderboard' |'screen.aiCoach' |'screen.reactionTrainer' |'screen.scouting' |'screen.settings' |'screen.records'
  // Common actions
  | 'action.signIn' |'action.signUp' |'action.logIn' |'action.createAccount' |'action.save' |'action.cancel' |'action.delete' |'action.confirm' |'action.back' |'action.loadMore' |'action.retry' |'action.start' |'action.pause' |'action.finish' |'action.nextExercise' |'action.edit' |'action.launch' |'action.next'
  // Stats
  | 'stats.totalSessions' |'stats.repetitions' |'stats.averageScore' |'stats.sessionsPerWeek' |'stats.weeklyActivity' |'stats.categoryPerformance' |'stats.recentSessions' |'stats.streakDays' |'stats.weekGoalLabel' |'stats.title' |'stats.viewRecords' |'stats.recordsDesc' |'stats.sessionsLabel' |'stats.exercisesLabel' |'stats.repsLabel' |'stats.dateLabel' |'stats.noStatsDesc' |'stats.startTraining'
  // Workout
  | 'workout.score' |'workout.rep' |'workout.time' |'workout.sessionSummary'
  // Empty states
  | 'empty.noData' |'empty.startFirstWorkout' |'empty.noDataAvailable' |'empty.readyToStart' |'empty.startFirstDesc' |'empty.startTraining' |'empty.noRecentActivity' |'empty.noRecentDesc' |'empty.noAchievements' |'empty.noAchievementsDesc' |'empty.noLeaderboard' |'empty.noRecords' |'empty.noRecordsDesc' |'empty.noMatchingDrills'
  // Common
  | 'common.loadFailed' |'common.retry' |'common.sessions' |'common.exercises' |'common.reps' |'common.player' |'common.players'
  // Settings labels
  | 'settings.weeklySessionGoal' |'settings.weeklyRepGoal' |'settings.preferredRest' |'settings.sound' |'settings.haptics' |'settings.language' |'settings.notifications' |'settings.training' |'settings.general' |'settings.account' |'settings.weeklyGoals' |'settings.sessionsPerWeek' |'settings.repsPerWeek' |'settings.restDuration' |'settings.preferences' |'settings.streakReminders' |'settings.challengeUpdates' |'settings.achievementsNotif' |'settings.experimentalFeatures' |'settings.experimentalDesc' |'settings.billing' |'settings.currentPlan' |'settings.viewOffers' |'settings.dataPrivacy' |'settings.saved' |'settings.saveError' |'settings.loadError' |'settings.activated' |'settings.disabled' |'settings.developedWith'
  // Home screen
  | 'home.recommendationsAI' |'home.recentActivity' |'home.leaderboard' |'home.leaderboardDesc' |'home.cognitiveTraining' |'home.cognitiveTrainingDesc' |'home.exercises' |'home.reps' |'home.points' |'home.new' |'home.bestScore'
  // Landing page
  | 'landing.badge' |'landing.heroTitle1' |'landing.heroTitleHighlight' |'landing.heroTitle2' |'landing.heroSubtitle' |'landing.ctaPrimary' |'landing.ctaSecondary' |'landing.featuresTitle1' |'landing.featuresTitleHighlight' |'landing.featuresSubtitle' |'landing.stepsTitle1' |'landing.stepsTitleHighlight' |'landing.stepsSubtitle' |'landing.ctaTitle1' |'landing.ctaTitleHighlight' |'landing.ctaSubtitle' |'landing.copyright' |'landing.privacy' |'landing.contact' |'landing.feature1.title' |'landing.feature1.description' |'landing.feature2.title' |'landing.feature2.description' |'landing.feature3.title' |'landing.feature3.description' |'landing.feature4.title' |'landing.feature4.description' |'landing.feature5.title' |'landing.feature5.description' |'landing.feature6.title' |'landing.feature6.description' |'landing.step1.title' |'landing.step1.description' |'landing.step2.title' |'landing.step2.description' |'landing.step3.title' |'landing.step3.description' |'landing.stat1' |'landing.stat2' |'landing.stat3' |'landing.stat4' |'landing.socialProof' |'landing.demo' |'landing.feature7.title' |'landing.feature7.description' |'landing.feature8.title' |'landing.feature8.description' |'landing.testimonialsTitle' |'landing.testimonialsSubtitle' |'landing.testimonial1.name' |'landing.testimonial1.role' |'landing.testimonial1.quote' |'landing.testimonial2.name' |'landing.testimonial2.role' |'landing.testimonial2.quote' |'landing.testimonial3.name' |'landing.testimonial3.role' |'landing.testimonial3.quote' |'landing.testimonial4.name' |'landing.testimonial4.role' |'landing.testimonial4.quote' |'landing.testimonial5.name' |'landing.testimonial5.role' |'landing.testimonial5.quote' |'landing.testimonial6.name' |'landing.testimonial6.role' |'landing.testimonial6.quote' |'landing.testimonial7.name' |'landing.testimonial7.role' |'landing.testimonial7.quote' |'landing.testimonial8.name' |'landing.testimonial8.role' |'landing.testimonial8.quote' |'landing.statsBarTitle' |'landing.statsBar.activePlayers' |'landing.statsBar.sessionsCompleted' |'landing.statsBar.avgRating' |'landing.statsBar.avgImprovement' |'landing.statsBar.reviewsCount' |'pricing.review1' |'pricing.review1.author' |'pricing.review2' |'pricing.review2.author' |'pricing.review3' |'pricing.review3.author' |'pricing.reviewsTitle' |'landing.featuredIn' |'landing.awards' |'landing.award1' |'landing.award2' |'landing.award3' |'landing.pricingTitle' |'landing.pricingSubtitle' |'landing.pricingFree' |'landing.pricingPro' |'landing.pricingCta' |'landing.finalCtaTitle' |'landing.finalCtaSubtitle' |'landing.finalCtaPlaceholder' |'landing.finalCtaButton' |'landing.terms'
  // Difficulty
  | 'difficulty.beginner'
  | 'difficulty.intermediate' |'difficulty.advanced' |'difficulty.elite'
  // Positions
  | 'position.guard' |'position.forward' |'position.center' |'position.all_around'
  // Categories (CRITICAL)
  | 'category.pocket_ball' |'category.shifty' |'category.ball_handling' |'category.speed_change' |'category.defense' |'category.shooting' |'category.footwork' |'category.finishing' |'category.conditioning' |'category.all'
  // Grade labels (same in both)
  | 'grade.S' |'grade.A' |'grade.B' |'grade.C' |'grade.D' |'grade.F'
  // Reaction Trainer
  | 'reaction.title' |'reaction.direction' |'reaction.color' |'reaction.shotClock' |'reaction.reflexPure' |'reaction.rounds' |'reaction.reactionTime' |'reaction.correct' |'reaction.incorrect' |'reaction.startTraining' |'reaction.results' |'reaction.averageTime' |'reaction.bestTime' |'reaction.personalBest' |'reaction.newRecord' |'reaction.playAgain' |'reaction.directionDesc' |'reaction.colorDesc' |'reaction.shotClockDesc' |'reaction.reflexDesc' |'reaction.ratingLightning' |'reaction.ratingFast' |'reaction.ratingAverage' |'reaction.ratingSlow' |'reaction.history'
  // AI Coach
  | 'coach.title' |'coach.online' |'coach.offline' |'coach.personalCoach' |'coach.typeMessage' |'coach.send' |'coach.suggestedActions' |'coach.createPlan' |'coach.shootingAdvice' |'coach.ballHandlingAdvice' |'coach.defenseAdvice' |'coach.conditioningAdvice' |'coach.motivation' |'coach.clearChat' |'coach.clearChatDesc' |'coach.errorGeneric' |'coach.available247' |'coach.welcomeMessage'
  // Pricing
  | 'pricing.title' |'pricing.subtitle' |'pricing.free' |'pricing.freeDesc' |'pricing.pro' |'pricing.proDesc' |'pricing.elite' |'pricing.eliteDesc' |'pricing.popular' |'pricing.subscribe' |'pricing.currentPlan' |'pricing.securePayment' |'pricing.noCommitment' |'pricing.perMonth' |'pricing.alreadySubscribed' |'pricing.manageSubscription' |'pricing.subscriptionSoon' |'pricing.redirecting' |'pricing.networkError' |'pricing.sessionError' |'pricing.paymentError'
  // Workout Summary
  | 'summary.sessionComplete'
  | 'summary.overallGrade' |'summary.excellent' |'summary.veryGood' |'summary.good' |'summary.average' |'summary.belowAverage' |'summary.needsWork' |'summary.failed' |'summary.drillResults' |'summary.totalReps' |'summary.totalTime' |'summary.saveAndExit' |'summary.backToHome'
  // Camera Workout
  | 'camera.aiFormCheck' |'camera.analyzing' |'camera.goodPoints' |'camera.issues' |'camera.score'
  // Achievements
  | 'achievements.progression' |'achievements.allUnlocked' |'achievements.remaining' |'achievements.newUnlocks' |'achievements.newUnlocksDesc' |'achievements.locked'
  // Train Hub
  | 'train.title' |'train.subtitle' |'train.createExercise' |'train.createDesc' |'train.drillName' |'train.category' |'train.difficulty' |'train.description' |'train.instructions' |'train.choose' |'train.drillNamePlaceholder' |'train.descriptionPlaceholder' |'train.searchPlaceholder' |'train.favorites' |'train.allDrills'
  // Plans
  | 'plans.myPlans' |'plans.noPlans' |'plans.noPlansDesc' |'plans.createPlan' |'plans.launch' |'plans.editPlan' |'plans.deletePlan' |'plans.deleteTitle' |'plans.deleteDesc' |'plans.planDeleted' |'plans.planDeletedDesc' |'plans.emptyPlan' |'plans.emptyPlanDesc' |'plans.exercises' |'plans.deleting' |'plans.error'
  // Leaderboard
  | 'leaderboard.global' |'leaderboard.thisMonth' |'leaderboard.thisWeek' |'leaderboard.friends' |'leaderboard.you' |'leaderboard.yourPosition' |'leaderboard.keepTraining' |'leaderboard.noRanking' |'leaderboard.level' |'leaderboard.periodLabel'
  // Profile
  | 'profile.edit' |'profile.profileUpdated' |'profile.profileUpdatedDesc' |'profile.updateError' |'profile.playerDNA' |'profile.scoutingReport' |'profile.levelMax' |'profile.levelMaxReached' |'profile.xpRemaining' |'profile.totalXp' |'profile.goal' |'profile.memberSince' |'profile.editProfile' |'profile.fullName' |'profile.position' |'profile.level' |'profile.trainingGoal' |'profile.choosePosition' |'profile.chooseLevel' |'profile.chooseGoal' |'profile.xpHistory' |'profile.accountSection' |'profile.signOut' |'profile.deleteAccount' |'profile.deleteTitle' |'profile.deleteDesc' |'profile.accountDeleted' |'profile.accountDeletedDesc' |'profile.positionGuard' |'profile.positionForward' |'profile.positionCenter' |'profile.positionAllAround' |'profile.levelBeginner' |'profile.levelIntermediate' |'profile.levelAdvanced' |'profile.levelElite' |'profile.goalShooting' |'profile.goalBallHandling' |'profile.goalDefense' |'profile.goalConditioning' |'profile.goalGeneral'
  // Records
  | 'records.noRecords' |'records.noRecordsDesc' |'records.searchPlaceholder' |'records.drillsTried' |'records.avgRecords' |'records.mostImproved' |'records.trainingTime' |'records.newRecord' |'records.maxReps' |'records.avgTime' |'records.lastTime' |'records.improvement' |'records.decline' |'records.noSearchResults' |'records.noCategoryRecords' |'records.startTraining'
  // Onboarding
  | 'onboarding.step' |'onboarding.stepOf' |'onboarding.positionQuestion' |'onboarding.positionDesc' |'onboarding.levelQuestion' |'onboarding.levelDesc' |'onboarding.goalQuestion' |'onboarding.goalDesc' |'onboarding.next' |'onboarding.saveError' |'onboarding.posGuardDesc' |'onboarding.posForwardDesc' |'onboarding.posCenterDesc' |'onboarding.posAllAroundDesc' |'onboarding.lvlBeginnerDesc' |'onboarding.lvlIntermediateDesc' |'onboarding.lvlAdvancedDesc' |'onboarding.lvlEliteDesc' |'onboarding.goalShootingDesc' |'onboarding.goalBallHandlingDesc' |'onboarding.goalDefenseDesc' |'onboarding.goalConditioningDesc' |'onboarding.goalGeneralDesc' |'onboarding.posAllAround' |'onboarding.lvlElite' |'onboarding.goalConditioning' |'onboarding.goalGeneral' |'onboarding.welcome' |'onboarding.welcomeDesc' |'onboarding.skip' |'onboarding.profileTitle' |'onboarding.profileDesc' |'onboarding.nameLabel' |'onboarding.namePlaceholder' |'onboarding.nameRequired' |'onboarding.goalsTitle' |'onboarding.goalsDesc' |'onboarding.goalsMin' |'onboarding.summaryTitle' |'onboarding.summaryDesc' |'onboarding.goToDashboard' |'onboarding.nameSummary' |'onboarding.positionSummary' |'onboarding.levelSummary' |'onboarding.goalsSummary' |'onboarding.posPG' |'onboarding.posSG' |'onboarding.posSF' |'onboarding.posPF' |'onboarding.posC' |'onboarding.lvlPro' |'onboarding.goalImproveShooting' |'onboarding.goalImproveShootingDesc' |'onboarding.goalGetInShape' |'onboarding.goalGetInShapeDesc' |'onboarding.goalUnderstandGame' |'onboarding.goalUnderstandGameDesc' |'onboarding.goalMatchPrep' |'onboarding.goalMatchPrepDesc'
  // Drill Detail
  | 'drill.errorLoading' |'drill.notFound' |'drill.addFavorite' |'drill.removeFavorite' |'drill.addedFavorite' |'drill.removedFavorite' |'drill.favoriteDrill' |'drill.favoriteError' |'drill.duration' |'drill.repetitions' |'drill.level' |'drill.instructions' |'drill.startWithCamera'
  // Scouting
  | 'scouting.estimated'
  // Auth
  | 'auth.subtitle' |'auth.password' |'auth.showPassword' |'auth.hidePassword' |'auth.forgotPassword' |'auth.loginError' |'auth.networkError' |'auth.signupCreatedError' |'auth.genericError' |'auth.passwordMinLength' |'auth.passwordMismatch' |'auth.tokenCopied'
  // Errors
  | 'error.loadFailed' |'error.serverError'
  // Day names
  | 'dayNames.mon' |'dayNames.tue' |'dayNames.wed' |'dayNames.thu' |'dayNames.fri' |'dayNames.sat' |'dayNames.sun'
  // Misc
  | 'common.on' |'common.off' |'common.weekly' |'language.fr' |'language.en'
  // Auth - extended
  | 'auth.fullName' |'auth.email' |'auth.emailPlaceholder' |'auth.loginLoading' |'auth.signupLoading' |'auth.passwordPlaceholder' |'auth.signupPasswordPlaceholder' |'auth.termsText' |'auth.resetTitle' |'auth.resetDesc' |'auth.sendResetEmail' |'auth.resetEmailSent' |'auth.resetEmailSentDesc' |'auth.continueWithGoogle' |'auth.orContinueWith' |'auth.setPassword' |'auth.setPasswordDesc' |'auth.passwordUpdated' |'auth.passwordUpdatedDesc' |'auth.backToLogin'
  // Home - extended
  | 'home.today' |'home.noSessionsWeek' |'home.viewProfile' |'home.calendarSection' |'home.weeklyChallengeSection'
  // Train Hub - extended
  | 'train.filterFavorites' |'train.resetFilters' |'train.filterByDifficulty' |'train.addFavorite' |'train.removeFavorite'
  // Profile - extended
  | 'profile.namePlaceholder'
  // Settings - extended
  | 'settings.selectPlaceholder' |'settings.exportSuccess' |'settings.exportError' |'settings.exportNetworkError' |'settings.privacyLoadError' |'settings.deleteAccountSuccess' |'settings.deleteAccountError' |'settings.deleteAccountButton' |'settings.deleteConfirm1' |'settings.deleteConfirm2' |'settings.deleteConfirm3' |'settings.deleteFinalButton' |'settings.deleteFinalDesc'
  // Camera Workout - extended
  | 'camera.saveSuccess' |'camera.saveError' |'camera.saveErrorDesc' |'camera.back' |'camera.muteSound' |'camera.unmuteSound' |'camera.cameraStream'
  // Workout Summary - extended
  | 'summary.copySuccess' |'summary.bestExercise' |'summary.estimatedCalories' |'summary.shareTitle'
  // Scouting - extended
  | 'scouting.insufficientData' |'scouting.startTrainingForAnalysis' |'scouting.recommendationMinSessions' |'scouting.goodLevel' |'scouting.maintainTraining' |'scouting.radarLabel' |'scouting.back' |'scouting.improvements' |'scouting.strengths'
  // Onboarding - extended
  | 'onboarding.ariaPosition' |'onboarding.ariaLevel' |'onboarding.ariaGoal'
  // Plans - extended
  | 'plans.launchPlan' |'plans.editPlanAria' |'plans.deletePlanAria' |'plans.createPlanAria' |'plans.repsShort' |'plans.publicBadge'
  // Reaction Trainer - extended
  | 'reaction.directionShort' |'reaction.colorShort' |'reaction.shotClockShort' |'reaction.reflexShort' |'reaction.tap' |'reaction.dontTap'
  // Pricing - extended
  | 'pricing.freeTierName' |'pricing.freeTierDesc' |'pricing.proTierDesc' |'pricing.eliteTierDesc' |'pricing.redirectingToast'
  // Pricing features
  | 'pricing.feature.basicExercises' |'pricing.feature.simpleStats' |'pricing.feature.limitedCoach' |'pricing.feature.fullScouting' |'pricing.feature.reactionTraining' |'pricing.feature.dataExport' |'pricing.feature.unlimitedSessions' |'pricing.feature.allExercises' |'pricing.feature.unlimitedCoach' |'pricing.feature.customPlans' |'pricing.feature.advancedVideo' |'pricing.feature.prioritySupport' |'pricing.feature.eliteBadge' |'pricing.feature.allInPro'
  // Auth - name placeholder
  | 'auth.namePlaceholder'
  // Train Hub - extended
  | 'train.instructionsPlaceholder' |'train.targetReps' |'train.icon'
  // Profile - extended
  | 'profile.viewAll' |'profile.quickSummary' |'profile.noXpYet' |'profile.completeDrillsForXp' |'profile.deleteDataDesc' |'profile.deleteDataItem1' |'profile.deleteDataItem2' |'profile.deleteDataItem3' |'profile.deleteDataItem4' |'profile.deleteDataItem5' |'profile.deleteDataItem6' |'profile.deleteDataItem7' |'profile.deleteAutoLogout'
  // Settings - extended
  | 'settings.exportData'
  | 'settings.exportDataDesc' |'settings.privacyPolicy' |'settings.privacyPolicyDesc'
  // Workout Summary - extended
  | 'summary.scorePerExercise'
  // Camera Workout - extended
  | 'camera.loadingDrill' |'camera.errorTitle' |'camera.loadingModel' |'camera.initCamera'
  // Reaction Trainer - extended
  | 'reaction.round' |'reaction.situation' |'reaction.up' |'reaction.down' |'reaction.left' |'reaction.right' |'reaction.target' |'reaction.accuracy' |'reaction.streak' |'reaction.bestStreak' |'reaction.targetsHit' |'reaction.shotClockInfo'
  // Scouting - extended
  | 'scouting.title' |'scouting.scoreOutOf100' |'scouting.averageLevel' |'scouting.yourScore'
  // Home - extended
  | 'home.loadSessionsError'
  // Social features
  | 'social.friends' |'social.teams' |'social.challenges' |'social.feed' |'social.messages' |'social.live' |'social.notifications' |'social.sendRequest' |'social.accept' |'social.decline' |'social.block' |'social.unblock' |'social.createTeam' |'social.joinTeam' |'social.leaveTeam' |'social.inviteMembers' |'social.createChallenge' |'social.joinChallenge' |'social.challengeProgress' |'social.createPost' |'social.likePost' |'social.comment' |'social.reply' |'social.follow' |'social.unfollow' |'social.followers' |'social.following' |'social.startLive' |'social.joinLive' |'social.liveScore' |'social.sendMessage' |'social.newConversation' |'social.searchPlayers'
  // Video features
  | 'video.library' |'video.upload' |'video.player' |'video.compare' |'video.annotations' |'video.highlights' |'video.export' |'video.share' |'video.slowMo' |'video.frameByFrame' |'video.speed' |'video.loop' |'video.drawTool' |'video.textTool' |'video.arrowTool' |'video.circleTool' |'video.generateHighlights' |'video.exportGif' |'video.sideBySide'
  // AI features
  | 'ai.insights' |'ai.voiceCoach' |'ai.predictions' |'ai.workoutGen' |'ai.ragQuery' |'ai.formAnalysis' |'ai.shotDetection' |'ai.poseTracking' |'ai.structuredOutput' |'ai.personalizedRecs' |'ai.generateWorkout' |'ai.saveWorkout' |'ai.workoutReasoning'
  // Core features
  | 'core.emailVerify'
  | 'core.twoFactor' |'core.devices' |'core.offline' |'core.dataExport' |'core.accountDeletion' |'core.passwordReset' |'core.pushNotifications' |'core.deepLink' |'core.multiDevice' |'core.notifications' |'core.privacy' |'core.security' |'core.language' |'core.data'
  // Settings - new sections
  | 'settings.notifMessages'
  | 'settings.notifSocial' |'settings.notifLive' |'settings.publicProfile' |'settings.publicProfileDesc' |'settings.showLeaderboard' |'settings.showLeaderboardDesc' |'settings.showActivity' |'settings.showActivityDesc' |'settings.twoFactor' |'settings.twoFactorDesc' |'settings.enable2fa' |'settings.disable2fa' |'settings.setup2fa' |'settings.twoFactorEnabled' |'settings.twoFactorDisabled' |'settings.backupCodes' |'settings.backupCodesDesc' |'settings.generateBackupCodes' |'settings.changePassword' |'settings.currentPassword' |'settings.newPassword' |'settings.confirmNewPassword' |'settings.passwordUpdated' |'settings.passwordError' |'settings.activeSessions' |'settings.activeSessionsDesc' |'settings.currentDevice' |'settings.lastActive' |'settings.revokeDevice' |'settings.deviceRevoked' |'settings.noDevices' |'settings.csvExport' |'settings.csvExportDesc' |'settings.softDelete' |'settings.softDeleteDesc' |'settings.gracePeriod' |'settings.reactivateAccount' |'settings.verified' |'settings.notVerified' |'settings.sendVerification' |'settings.verificationSent' |'settings.emailVerified' |'settings.verificationRequired' |'settings.offlineMode' |'settings.offlineModeDesc' |'settings.syncData' |'settings.syncSuccess' |'settings.syncError' |'settings.pendingActions' |'settings.pushEnabled' |'settings.pushDesc' |'settings.deepLinkInfo' |'settings.deepLinkInfoDesc'
  // Workout - extended (overlay)
  | 'workout.sessionCompleteTitle'
  | 'workout.repsLabel' |'workout.duration' |'workout.redo' |'workout.paused' |'workout.remaining' |'workout.sets' |'workout.objective' |'workout.repetitions' |'workout.formExcellent' |'workout.formGood' |'workout.formImprove'
  // Feedback messages
  | 'feedback.goodPosture' |'feedback.leanRight' |'feedback.leanLeft' |'feedback.tooSlow' |'feedback.goodSpeed' |'feedback.armsLow' |'feedback.keepGoing' |'feedback.greatForm' |'feedback.narrowStance' |'feedback.wideStance'
  // Pricing - extended
  | 'pricing.monthly' |'pricing.annual' |'pricing.perYear'
  // Cookie consent
  | 'cookie.description' |'cookie.preferences' |'cookie.analytics' |'cookie.analyticsDesc' |'cookie.accept' |'cookie.reject' |'cookie.moreInfo'
  // PWA install prompt
  | 'pwa.title' |'pwa.description' |'pwa.install' |'pwa.later' |'pwa.close'
  // Navigation - extended
  | 'nav.messages'
  // Paywall
  | 'paywall.title' |'paywall.viewPlans' |'paywall.later' |'paywall.scoutingDesc' |'paywall.aiCoachDesc' |'paywall.reactionTrainerDesc' |'paywall.proIncludes' |'paywall.proInclude1' |'paywall.proInclude2' |'paywall.proInclude3' |'paywall.proInclude4' |'paywall.messages.searchPlayer' |'paywall.messages.noResults' |'paywall.messages.selectPlayer'
  // Admin dashboard
  | 'admin.title' |'admin.overview' |'admin.users' |'admin.aiUsage' |'admin.system' |'admin.totalUsers' |'admin.activeToday' |'admin.mrr' |'admin.aiCallsToday' |'admin.signups30d' |'admin.usageByType' |'admin.subscriptionDist' |'admin.recentSignups' |'admin.dbConnections' |'admin.queueDepth' |'admin.errorRate' |'admin.email' |'admin.date' |'admin.plan' |'admin.free' |'admin.pro' |'admin.unauthorized' |'admin.unauthorizedDesc' |'admin.loadFailed'
...
const translations: Record<AppLanguage, Record<TranslationKey, string>> = {
  fr: {
    ...
    'landing.testimonial1.role': "Joueur NBA G-League",
    'landing.testimonial1.quote': "CourtVision AI a complètement changé mon jeu. L'analyse de forme en temps réel a détecté un défaut dans ma mécanique de tir que les coachs n'avaient pas vu depuis des années. Mon pourcentage à 3 points est passé de 32% à 41% en seulement 8 semaines.",
    'landing.testimonial2.name': 'Aisha Williams',
    'landing.testimonial2.role': 'Joueuse Division I Universitaire',
    'landing.testimonial2.quote': "Le coaching IA, c'est comme avoir un entraîneur personnel 24h/24. Les exercices personnalisés basés sur mes faiblesses m'ont aidée à décrocher une place de titulaire.",
    'landing.testimonial3.name': 'Lucas Martin',
    'landing.testimonial3.role': 'Joueur professionnel, France',
    'landing.testimonial3.quote': "En tant que joueur professionnel, je pensais connaître tous les exercices. CourtVision AI m'a prouvé le contraire avec des analyses de forme en temps réel incroyablement précises.",
    'landing.testimonial4.name': 'Kenji Tanaka',
    'landing.testimonial4.role': 'Étoile lycéenne, Japon',
    'landing.testimonial4.quote': "Je suis passé de remplaçant à capitaine de l'équipe en une saison. Le système d'XP et les séries m'ont motivé comme rien d'autre.",
    'landing.testimonial5.name': 'Sarah Okafor',
    'landing.testimonial5.role': 'MVP Ligue Amateur',
    'landing.testimonial5.quote': "Le trainer de réaction et les outils d'analyse vidéo sont des game-changers. Je peux maintenant lire les défenses mieux et mon nombre de passes décisives a doublé.",
    'landing.testimonial6.name': 'David Chen',
    'landing.testimonial6.role': 'PDG, SportTech Ventures',
    'landing.testimonial6.quote': "CourtVision AI représente l'avenir de l'entraînement sportif. Leur approche IA-first et leur base de 50 000+ utilisateurs en moins d'un an est remarquable. Nous avons investi parce que le produit parle de lui-même.",
    'landing.testimonial7.name': 'Marie Dubois',
    'landing.testimonial7.role': 'Fondatrice, BasketballTech Europe',
    'landing.testimonial7.quote': "J'ai vu des centaines d'applications sportives. CourtVision AI est de loin la plus impressionnante. L'intégration de l'analyse de pose en temps réel est techniquement brillante.",
    'landing.testimonial8.name': 'James Rodriguez',
    'landing.testimonial8.role': 'Partenaire, Sequoia Capital',
    'landing.testimonial8.quote': "La capacité de l'équipe à combiner vision par ordinateur, coaching IA et gamification en une expérience fluide est rare. CourtVision AI a le potentiel de devenir le Strava du basketball.",
    'landing.statsBarTitle': "Fait confiance par 50 000+ joueurs dans le monde",
    ...
    'landing.statsBar.reviewsCount': '12 450+ avis',
    ...
    'pricing.reviewsTitle': 'Ce que disent nos joueurs',
    'pricing.review1': "Le plan Pro vaut chaque centime. Mon pourcentage à 3 points a bondi de 10% en 2 mois grâce aux exercices personnalisés.",
    'pricing.review1.author': '— Marcus J., Joueur NBA G-League',
    'pricing.review2': "Passer de gratuit à Elite a été la meilleure décision. L'analyse vidéo avancée m'a ouvert les yeux sur ma mécanique.",
    'pricing.review2.author': '— Aisha W., Joueuse Division I',
    'pricing.review3': "9,99€/mois pour un coach IA personnel ? C'est un vol. Mon équipe est passée de 8-12 à 16-4 cette saison.",
    'pricing.review3.author': '— Coach D. Williams, AAU National Champions',
  ...
  en: {
    ...
    'landing.testimonial1.name': 'Marcus Johnson',
    'landing.testimonial1.role': 'NBA G-League Player',
    'landing.testimonial1.quote': "CourtVision AI changed my game completely. The real-time form analysis caught a flaw in my shooting mechanics that coaches missed for years. My 3PT% went from 32% to 41% in just 8 weeks.",
    'landing.testimonial2.name': 'Aisha Williams',
    'landing.testimonial2.role': 'Division I College Player',
    'landing.testimonial2.quote': "The AI coaching is like having a personal trainer 24/7. The personalized drills based on my weaknesses helped me earn a starting spot.",
    'landing.testimonial3.name': 'Lucas Martin',
    'landing.testimonial3.role': 'Pro Player, France',
    'landing.testimonial3.quote': "As a professional player, I thought I knew every drill. CourtVision AI proved me wrong with incredibly precise real-time form analysis.",
    'landing.testimonial4.name': 'Kenji Tanaka',
    'landing.testimonial4.role': 'High School Star, Japan',
    'landing.testimonial4.quote': "I went from bench warmer to team captain in one season. The XP system and streaks kept me motivated like nothing else.",
    'landing.testimonial5.name': 'Sarah Okafor',
    'landing.testimonial5.role': 'Amateur League MVP',
    'landing.testimonial5.quote': "The reaction trainer and video analysis tools are game-changers. I can now read defenses better and my assist numbers doubled.",
    'landing.testimonial6.name': 'David Chen',
    'landing.testimonial6.role': 'CEO, SportTech Ventures',
    'landing.testimonial6.quote': "CourtVision AI represents the future of sports training. Their AI-first approach and 50K+ user base in under a year is remarkable. We invested because the product speaks for itself.",
    'landing.testimonial7.name': 'Marie Dubois',
    'landing.testimonial7.role': 'Founder, BasketballTech Europe',
    'landing.testimonial7.quote': "I've seen hundreds of sports applications. CourtVision AI is by far the most impressive. The integration of real-time pose analysis is technically brilliant.",
    'landing.testimonial8.name': 'James Rodriguez',
    'landing.testimonial8.role': 'Partner, Sequoia Capital',
    'landing.testimonial8.quote': "The team's ability to combine computer vision, AI coaching, and gamification into one seamless experience is rare. CourtVision AI has the potential to become the Strava of basketball.",
    ...
    'landing.statsBar.reviewsCount': '12,450+ reviews',
    ...
    'pricing.reviewsTitle': 'What our players say',
    'pricing.review1': "The Pro plan is worth every penny. My 3PT% jumped 10% in 2 months thanks to the personalized drills.",
    'pricing.review1.author': '— Marcus J., NBA G-League Player',
    'pricing.review2': "Upgrading from Free to Elite was the best decision. The advanced video analysis opened my eyes to my mechanics.",
    'pricing.review2.author': '— Aisha W., Division I College Player',
    'pricing.review3': "$9.99/mo for a personal AI coach? That's a steal. My team went from 8-12 to 16-4 this season.",
    'pricing.review3.author': '— Coach D. Williams, AAU National Champions',
...
export function i18n(...args) {
  ...
  console.warn('Placeholder: i18n is not implemented yet.', args);
  return null;
}
