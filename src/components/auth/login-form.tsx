    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          autoComplete="email" aria-describedby="login-error" aria-invalid={!!error}
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          <Input
            ...
            placeholder={t('auth.passwordPlaceholder')} disabled={loading} required
        ...
        <div className="text-right pt-1">
          <button type="button" className="text-xs text-orange-500/70 hover:text-orange-500 transition-colors cursor-pointer" onClick={onForgotPassword}>
      ...
      {error && (
        <motion.p id="login-error" initial={{ opacity: 0, y: -4 }} animate={{ opacity: 1, y: 0 }}
      ...
      <Button type="submit" disabled={loading}
        ...
        {loading ? (<><Loader2 className="size-4 animate-spin" />{t('auth.loginLoading')}</>) : t('action.logIn')}
      </Button>
    </form>
  )
}